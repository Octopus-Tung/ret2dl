  ...
  if (l->l_info[DT_JMPREL] && lazy)
      ...
      if (got[1])
	{
      ...
      *(ElfW(Addr) *) (got + 1) = (ElfW(Addr)) l;
      ...
      PTR_MANGLE(*(ElfW(Addr) *) (got + 1));
      l->l_info[DT_RELENT] = (unsigned long) D_PTR (l, l_info[DT_PLTRELSZ]) + (unsigned long) D_PTR (l, l_info[DT_JMPREL]);
      ...
      if (__glibc_unlikely (profile))
	{
	  if (HAS_ARCH_FEATURE (AVX512F_Usable))
	    *(ElfW(Addr) *) (got + 2) = (ElfW(Addr)) ((unsigned long)&_dl_runtime_profile_avx512);
	  else if (HAS_ARCH_FEATURE (AVX_Usable))
	    *(ElfW(Addr) *) (got + 2) = (ElfW(Addr)) ((unsigned long)&_dl_runtime_profile_avx);
	  else
	    *(ElfW(Addr) *) (got + 2) = (ElfW(Addr)) ((unsigned long)&_dl_runtime_profile_sse);
      ...
      else
	{
	  ...
	  if (GLRO(dl_x86_cpu_features).xsave_state_size != 0)
	    *(ElfW(Addr) *) (got + 2)
		 ...
		 ? (ElfW(Addr)) ((unsigned long)&_dl_runtime_resolve_xsavec)
		 : (ElfW(Addr)) ((unsigned long)&_dl_runtime_resolve_xsave));
	  else
	    *(ElfW(Addr) *) (got + 2)
	      = (ElfW(Addr)) ((unsigned long)&_dl_runtime_resolve_fxsave);
	}
    }
